...
import com.ywq.server.model.request.MovieRatingRequest;
...
public class RatingService {
    ...
    private MongoCollection<Document> getRatingCollection() {
        if (null == ratingCollection){
            ratingCollection = mongoClient.getDatabase(Constant.MONGO_DATABASE).getCollection(Constant.MONGO_RATING_COLLECTION);
        }
